...
namespace Inventory_management.dal.Migrations
{
    ...
    [Migration("20250120153645_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory_management.dal.Models.Product.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Inventory_management.dal.Models.Product.DepartmentTranslate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Inventory_management.dal.Models.Product.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Inventory_management.dal.Models.Product.DepartmentTranslate", b =>
                {
                    b.HasOne("Inventory_management.dal.Models.Product.Department", "Department")
            ...
            modelBuilder.Entity("Inventory_management.dal.Models.Product.Product", b =>
                {
                    ...
                    b.HasOne("Inventory_management.dal.Models.Product.Employee", "Employee")
                        .WithMany("Products")
